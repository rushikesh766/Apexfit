...
const navItems: NavItem[] = [
  { id: "home", label: "Dashboard", icon: Home, href: "/trainer" },
  { id: "students", label: "My Students", icon: Users, href: "/trainer/students" },
  { id: "attendance", label: "Attendance", icon: UserCheck, href: "/trainer/attendance" },
  { id: "workouts", label: "Workout Plans", icon: Dumbbell, href: "/trainer/workouts" },
  { id: "diet", label: "Diet Plans", icon: Salad, href: "/trainer/diet" },
  { id: "messages", label: "Messages", icon: MessageSquare, href: "/trainer/messages" },
];
        ...
        >
          ...
          {sidebarOpen && (
            <div>
              ...
              <p style={{ fontSize: "0.6875rem", color: "var(--muted)", lineHeight: 1.2 }}>Trainer Portal</p>
            </div>
          )}
        </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "0.6875rem", color: "var(--muted)" }}>Trainer Portal</p>
            </div>
          </div>
          <button
            type="button"
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "0.75rem", color: "var(--muted)" }}>Manage your students and training programs</p>
            </div>
          </div>
